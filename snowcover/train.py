...
topo_file = 'SNOTEL/raw_snotel_topo_30m.nc' # 30m DEM
...
forcings = {'pr': 'pr_snowcover.nc', 
            # 'rave': '../gridMET/rave_1980_2018.nc',
            'sph': 'sph_snowcover.nc', 
            'srad': 'srad_snowcover.nc', 
            'tmmn': 'tmmn_snowcover.nc',
            'tmmx': 'tmmx_snowcover.nc', 
            'vs': 'vs_snowcover.nc'}

path = dt_string+'-multi/'
path = dt_string+style+'/'
...
swe_ds = []
forcings = {'pr': '../gridMET/pr_wus_clean.nc',
            'sph': '../gridMET/sph_wus_clean.nc', 
            'srad': '../gridMET/srad_wus_clean.nc', 
            'tmmn': '../gridMET/tmmn_wus_clean.nc',
            'tmmx': '../gridMET/tmmx_wus_clean.nc', 
            'vs': '../gridMET/vs_wus_clean.nc'}
