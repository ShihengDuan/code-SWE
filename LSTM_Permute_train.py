...
for permute_id in range(len(forcings)):
    ...
    path = '/tempest/duan0000/SWE/gridMET/runs_permute_30m/' + model_type.upper() + '/'
    ...
    for e in range(5):  # ens number
        ...
        torch.save(model1.state_dict(), path + feature + '_model_ens_' + str(e))
        torch.save(model2.state_dict(), path + feature + '_model_ens_' + str(9-e))
        result_true = {}
        result_pred = {}
        result_pred2 = {}
        ...
        with open(path + feature + '_result_true_' + str(e), 'wb') as f:
            pickle.dump(result_true, f)
        with open(path + feature + '_result_pred_' + str(e), 'wb') as f:
            pickle.dump(result_pred, f)
        with open(path + feature + '_result_pred_' + str(9-e), 'wb') as f:
